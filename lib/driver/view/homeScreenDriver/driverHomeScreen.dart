...
import 'package:uber_clone/driver/controller/providers/geofireServices.dart';
          ...
          child: Padding(
            ...
            child: StreamBuilder(
              ...
              builder: (context, event) {
                ...
                // if driver has 0 rides yet. no driver status value in DB
                if (event.data == null) {
                  return SwipeButton(
                    ...
                    onSwipe: () {
                      ...
                      GeoFireSerivice.goOnline();
                      GeoFireSerivice().updateLocationRealTime(context);
                    },
                    child: Builder(
                      builder: (context) {
                        return Text(
                ...
                if (event.data != null) {
                  ...
                  if (profileData.driverStatus == 'ONLINE') {
                    return SwipeButton(
                      ...
                      onSwipe: () {
                        log('Button is swiped');
                        GeoFireSerivice().goOffline(context);
                      },
                      child: Builder(
                        builder: (context) {
                          return Text(
