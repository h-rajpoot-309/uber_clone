...
class _ServiceScreenRiderState extends State<ServiceScreenRider> {
  List firstRow = [
    ['assets/images/services/trip.png', 'Trip'],
    ['assets/images/services/rentals.png', 'Rentals'],
  ];
  List secondRow = [
    ['assets/images/services/reserve.png', 'Reserve'],
    ['assets/images/services/intercity.png', 'Intercity'],
    ['assets/images/services/groupRide.png', 'Group Ride'],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Services', style: AppTextStyles.heading20Bold),
      ),
      body: ListView(
                ...
                .map(
                  (e) => Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(e[1], style: AppTextStyles.small12),
                        SizedBox(
                          height: 8.h,
                          width: 8.h,
                          child: Image(
                  ...
                  (e) => Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(e[1], style: AppTextStyles.small8),
                      ],
                    ),
                  ),
                )
