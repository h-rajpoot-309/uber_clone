  ...
  factory ProfileDataModel.fromMap(Map<String, dynamic> map) {
    return ProfileDataModel(
      ...
      vehicleBrandName: map['vehicleBrandName'] != null
          ...
          : null,
      vehicleModel: map['vehicleModel'] != null
          ? map['vehicleModel'] as String
          : null,
      vehicleType: map['vehicleType'] != null
          ? map['vehicleType'] as String
          : null,
      ...
      activeRideRequestID: map['activeRideRequestID'] != null
          ...
          : null,
      driverStatus: map['driverStatus'] != null
          ? map['driverStatus'] as String
          : null,
